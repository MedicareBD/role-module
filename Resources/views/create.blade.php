    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.roles.store') }}" method="post" class="row instant_reload_form">
                    @csrf

                    <div class="col-12 form-group">
                        <label for="name" class="required">{{ __("Role Name") }}</label>
                        <input type="text" name="name" id="name" class="form-control" placeholder="{{ __("Enter role name") }}" autofocus required>
                    </div>
