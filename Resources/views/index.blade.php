                            ...
                            <ul class="list-unstyled d-flex align-items-center avatar-group mb-0">
                                @foreach($role->users->take(5) as $user)
                                    <li class="avatar avatar-sm pull-up">
                                        <img class="rounded-circle" src="{{ asset('admin/img/avatar/avatar-1.png') }}" alt="{{ $user->name }}">
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div class="d-flex align-items-end justify-content-center h-100">
                            <img src="{{ asset('admin/img/drawkit/faq-illustrations.svg') }}" class="img-fluid mt-2" alt="Image" width="85">
                        </div>
                    </div>
                    <div class="col-sm-7">
